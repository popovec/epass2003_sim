...
#define T_RECORD_APPEND 0xff
#define T_RECORD_CURRENT 0xfe

#define T_RECORD_FIRST 0
#define T_RECORD_LAST 1
#define T_RECORD_NEXT 2
#define T_RECORD_PREV 3
#define T_RECORT_NUMBER 4
